	...
	<gracePage :customHeader="true">
		...
		<view slot="gBody" class="grace-body">
			...
			<form @submit="loginNow" class="grace-form" style="margin-top:80rpx;">
				...
				<view class="grace-margin-top"><button style="background: #337ab7!important;" form-type="submit" type="primary" class="grace-button grace-border-radius grace-gtbg-blue">登录</button></view>
			</form>
