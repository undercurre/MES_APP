	...
	<gracePage :customHeader="true">
		<graceHeader slot="gHeader" background="#337ab7">
			<view class="grace-header-body">
				...
				<!-- 中间内容 -->
				<view class="grace-header-content-noflex main-tit"><text class="grace-white" style="font-size: 38rpx;">老化管理</text></view>
			</view>
		</graceHeader>
				...
				<view class="form-item">
					...
					<view >
								...
								<radio-group  @change="handleRadio">
									<radio :checked="Status==='N'" value="N" style="margin-right: 40rpx;">开始</radio>
									<radio :checked="Status==='Y'" value="Y">结束</radio>
								</radio-group>
...
<script src="./AgeingManager.js"></script>
