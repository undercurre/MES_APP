	...
	<gracePage :customHeader="true">
		...
		<view class="grace-stable" slot="gBody">
			<u-table style="position: relative;overflow-x: auto;">
				<u-tr style="position: sticky;top: 0;width: 2800rpx;">
				...
				<div :style="{
					...
					<u-tr style="width: 2800rpx;" v-for="(item, index) in tableData" :key="index">
						<u-td style="width: 250rpx;overflow: hidden;line-height: 21px;">{{ item.LOCATION || '' }}</u-td>
						<u-td style="width: 250rpx;overflow: hidden;line-height: 21px;">{{ item.FEEDER || '' }}</u-td>
