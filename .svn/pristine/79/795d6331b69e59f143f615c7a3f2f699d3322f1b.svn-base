				...
				<view class="form-content">
					<view class="form-item">
						...
						<view class="form-value">
							<input class="form-input"  type="text" v-model="Storage" placeholder=" " @confirm="getStorage"
							 :focus="autoFocus">
						</view>
					</view>
					<!-- <view class="form-item">
					...
					<view class="form-item">
						...
						<view class="form-value">
							<input class="form-input" type="text" v-model="Form.TONGS_BODYMARK" placeholder=" " :focus="checkReelFlag" @confirm="getFeida">
						</view>
					</view>
					<view class="form-item">
						<u-table style="position: relative;height: 900rpx;overflow: auto;">
							<u-tr class="u-tr" style="display: -webkit-box;position: sticky;top: 0;">
								...
								<u-th class="u-tr"style="width: 30%;flex: 0 0 30%;">工装名称</u-th>
								<u-th class="u-tr" style="width: 25%;flex: 0 0 25%;">储位</u-th>
							...
							<u-tr class="u-tr" style="display: -webkit-box;" v-for="(item, index) in list" :key="index">
								...
								<u-td class="u-tr" style="width: 30%;flex: 0 0 30%;overflow: hidden;line-height: 21px;">{{item.TONGS_TYPE }}</u-td>
								<u-td class="u-tr" style="width: 25%;flex: 0 0 25%;overflow: hidden;line-height: 21px;">{{item.STORE_NAME}}</u-td>
								<u-td class="u-tr" style="width: 20%;flex: 0 0 20%;overflow: hidden;line-height: 21px;">	
								    <text style="color: red;" v-if="item.KDETAIL_STATUS == '未盘点'">未盘点</text>
									<text style="color: rgb(3, 163, 89);" v-else>已盘点</text></u-td>
							</u-tr>
						</u-table>
					</view>
				</view>
