				...
				<view class="form-item">
					<u-table style="position: relative;">
						<u-tr style="position: sticky;top: 0;">
							<u-th style="width: 280rpx">钢网编号</u-th>
							<u-th style="width: 140rpx">钢网储位</u-th>
							<u-th style="width: 140rpx">使用次数</u-th>
							<u-th style="width: 140rpx">正反面</u-th>
						</u-tr>
						<u-tr v-for="(item, index) in list" :key="index">
							<u-td style="width: 280rpx;overflow: hidden;line-height: 21px;">{{ item.STENCIL_NO }}</u-td>
							<u-td style="width: 140rpx;overflow: hidden;line-height: 21px;">{{ item.LOCATION }}</u-td>
