		...
		<view slot="gBody" class="grace-body">
			...
			<graceBottomDialog :show="FeederShow" v-on:closeDialog="closeDialog1">
				...
				<view slot="content" class="dialog-content" style="padding: 0 10px;box-sizing: border-box;">
					...
					<uni-pagination style="width: 100%;" show-icon="true" :total="totalFeeder" @change="changeReason1" :current="Feederform.Page">
					</uni-pagination>
				</view>
			</graceBottomDialog>
			<!-- 根本原因 -->
			<graceBottomDialog :show="ReasonShow" v-on:closeDialog="closeDialog2">
				...
				<view slot="content" class="dialog-content" style="padding: 0 10px;box-sizing: border-box;">
					...
					<uni-pagination style="width: 100%;" show-icon="true" :total="totalReason" @change="changeReason2" :current="Reasonform.Page">
					</uni-pagination>
				</view>
			</graceBottomDialog>
			<!-- 损坏部件 -->
			<graceBottomDialog :show="DamageShow" v-on:closeDialog="closeDialog3">
				...
				<view slot="content" class="dialog-content" style="padding: 0 10px;box-sizing: border-box;">
					...
					<uni-pagination style="width: 100%;display: block;" show-icon="true" :total="totalDamage" @change="changeReason3"
